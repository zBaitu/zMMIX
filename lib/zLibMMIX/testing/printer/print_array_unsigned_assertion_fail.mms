    PREFIX :testing:printer:print_array_unsigned_assertion_fail
assertion_str   IS $0
actual_value    IS $1
expected_value  IS $2
max_str_len     IS $3
...
:testing:printer:print_array_unsigned_assertion_fail JMP @+4
    GET     rj_bak,:rJ
    SET     num,actual_value
    LDA     str,actual_value_str
    SET     str_len,max_str_len
    PUSHJ   param,:numeric:unsigned_num_to_str
