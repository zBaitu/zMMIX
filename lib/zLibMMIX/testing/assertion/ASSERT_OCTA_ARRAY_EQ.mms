    PREFIX :testing:assertion:ASSERT_OCTA_ARRAY_EQ
actual_array    IS $0
expected_array  IS $1
len_addr        IS $2
...
param   IS $3
                    ...
                    GREG @
ASSERTION_STR       BYTE    "ASSERT_OCTA_ARRAY_EQ",#a,0
...
:testing:assertion:ASSERT_OCTA_ARRAY_EQ JMP @+4
        LDO     len,len_addr
        SET     pos,0
loop    CMP     result,pos,len
        BNN     result,end
        SLU     offset,pos,3
        LDO     actual_value,actual_array,offset
        LDO     expected_value,expected_array,offset
