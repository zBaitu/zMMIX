    PREFIX :testing:assertion:ASSERT_BYTE_ARRAY_EQU
actual_array    IS $0
expected_array  IS $1
len_addr        IS $2
...
param   IS $3
                    ...
                    GREG @
ASSERTION_STR       BYTE    "ASSERT_BYTE_ARRAY_EQU",#a,0
...
:testing:assertion:ASSERT_BYTE_ARRAY_EQU JMP @+4
        LDO     len,len_addr
        SET     pos,0
loop    CMP     result,pos,len
        BNN     result,end
        LDBU    actual_value,actual_array,pos
        LDBU    expected_value,expected_array,pos
