...
FAILED_STR     BYTE "[FAILED]",0
    ...
    GREG @
    PREFIX :test_NUM_TO_STR:
suite_name    BYTE " test_NUM_TO_STR ",0
    PREFIX :test_NUM_TO_STR:positive_short_eq:
case_name    BYTE " positive_short_eq ",0
num                 OCTA    9
str                 BYTE    " ",0
len                 IS      1
...
expected_str_begin  OCTA str
    ...
    PREFIX :test_NUM_TO_STR:positive_eq:
case_name    BYTE " positive_eq ",0
num                 OCTA    12321
str                 BYTE    "          ",0
len                 IS      10
...
expected_str_begin  OCTA str+5
    ...
    PREFIX :test_NUM_TO_STR:positive_long_eq:
case_name    BYTE " positive_long_eq ",0
...
expected_str_begin  OCTA str+3
    ...
    PREFIX :test_NUM_TO_STR:negative_short_eq:
case_name    BYTE " negative_short_eq ",0
num                 OCTA    -1
str                 BYTE    "  ",0
len                 IS      2
...
expected_str_begin  OCTA str
    ...
    PREFIX :test_NUM_TO_STR:negative_eq:
case_name    BYTE " negative_eq ",0
num                 OCTA    -54321
str                 BYTE    "    -54321",0
len                 IS      10
...
expected_str_begin  OCTA str+4
    ...
    PREFIX :test_NUM_TO_STR:negative_long_eq:
case_name    BYTE " negative_long_eq ",0
...
:PrintStrAssetionFail GET rj_bak,:rJ
    ...
    PREFIX :EXPECT_STR_EQ
actual_value_addr   IS $0
expected_value_addr IS $1
param               IS $2

                    GREG @
ASSERTION_STR       BYTE "EXPECT_STR_EQ",#a,0
pos                 GREG
actual_value        GREG
expected_value      GREG
result              GREG
...
failed          GET     rj_bak,:rJ
    ...
    PREFIX :EXPECT_OCTA_EQ
value_addr          IS $0
expected_value_addr IS $1
MAX_NUM_STR_LEN     IS 20

                    GREG @
ASSERTION_STR       BYTE "EXPECT_OCTA_EQ",#a,0
value               GREG
expected_value      GREG
result              GREG
rj_bak              GREG

:EXPECT_OCTA_EQ LDO     value,value_addr
...
Main   JMP @+4
    ...
    LDA     $1,str
    LDA     $2,expected_str
    PUSHJ   $0,:EXPECT_STR_EQ
    LDA     $1,str_begin
    LDA     $2,expected_str_begin
    PUSHJ   $0,:EXPECT_OCTA_EQ
