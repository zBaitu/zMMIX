...
FAILED_STR     BYTE "[FAILED]",0
    ...
    GREG @
    PREFIX :test_EXPECT_TETRA_EQ:
suite_name    BYTE " test_EXPECT_TETRA_EQ ",0
    PREFIX :test_EXPECT_TETRA_EQ:eq:
case_name    BYTE " eq ",0
left    TETRA 123456789
right   TETRA 123456789

    PREFIX :test_EXPECT_TETRA_EQ:ne:
case_name    BYTE " ne ",0
left    TETRA #ffffffff
right   TETRA #fffffffe
...
:PrintStrAssetionFail GET rj_bak,:rJ
    ...
    PREFIX :EXPECT_TETRA_EQU
value_addr          IS $0
expected_value_addr IS $1
MAX_NUM_STR_LEN     IS 10

                    GREG @
ASSERTION_STR       BYTE "EXPECT_TETRA_EQU",#a,0
value               GREG
expected_value      GREG
result              GREG
rj_bak              GREG

:EXPECT_TETRA_EQU   LDTU    value,value_addr
