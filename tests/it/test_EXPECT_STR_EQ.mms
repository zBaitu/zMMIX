...
FAILED_STR     BYTE "[FAILED]",0
    ...
    GREG @
    PREFIX :test_EXPECT_STR_EQ:
suite_name    BYTE " test_EXPECT_STR_EQ ",0
    PREFIX :test_EXPECT_STR_EQ:eq:
case_name    BYTE " eq ",0
left    BYTE "abcdefg",0
right   BYTE "abcdefg",0

    PREFIX :test_EXPECT_STR_EQ:ne:
case_name    BYTE " ne ",0
left    BYTE "abcdefg",0
right   BYTE "abcdef",0

    PREFIX :test_EXPECT_STR_EQ:case_ne:
case_name    BYTE " case_ne ",0
left    BYTE "ABCDEFG",0
right   BYTE "abcdefg",0

    PREFIX :test_EXPECT_STR_EQ:zero_len_eq:
case_name    BYTE " zero_len_eq ",0
left    BYTE 0
right   BYTE 0

    PREFIX :test_EXPECT_STR_EQ:zero_len_ne:
...
0H              LDBU    actual_value,actual_value_addr,pos
