...
FAILED_STR     BYTE "[FAILED]",0
    ...
    GREG @
    PREFIX :test_EXPECT_OCTA_EQ:
suite_name    BYTE " test_EXPECT_OCTA_EQ ",0
    PREFIX :test_EXPECT_OCTA_EQ:eq:
case_name    BYTE " eq ",0
left    OCTA 12345678987654321
right   OCTA 12345678987654321

    PREFIX :test_EXPECT_OCTA_EQ:ne:
case_name    BYTE " ne ",0
//left    OCTA #8000000000000000
//right   OCTA #8000000000000001
left    OCTA #8000000000000000
right   OCTA #8000000000000001
