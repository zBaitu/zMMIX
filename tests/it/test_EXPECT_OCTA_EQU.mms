...
FAILED_STR     BYTE "[FAILED]",0
    ...
    GREG @
    PREFIX :test_EXPECT_OCTA_EQU:
suite_name    BYTE " test_EXPECT_OCTA_EQU ",0
    PREFIX :test_EXPECT_OCTA_EQU:eq:
case_name    BYTE " eq ",0
left    OCTA 12345678987654321
right   OCTA 12345678987654321

    PREFIX :test_EXPECT_OCTA_EQU:ne:
case_name    BYTE " ne ",0
left    OCTA #ffffffffffffffff
right   OCTA #fffffffffffffffe
